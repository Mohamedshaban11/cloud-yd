  ...
  return (
    <div name='home' className=" w-full h-screen bg-zinc-200 flex flex-col justify-between">
      <div className=" grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className=" flex flex-col justify-center px-2 py-8 w-full md:items-start">
        ...
        <div className="  relative flex flex-col py-8 md:min-w-[760px] bottom-[5%] mx-1 md:left-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl">
          <p>Data Services</p>
