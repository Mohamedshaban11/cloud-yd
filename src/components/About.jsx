      ...
      <div className=" max-w-[1240px] mx-auto">
        <div className=" text-center">
          ...
          <p className="text-3xl py-6 text-gray-500">
            ...
            facere magni ipsam officia sed quam rerum nostrum, minima eos
            tempora consectetur aliquam voluptates, consequuntur exercitationem
            sint tempore perferendis qui reiciendis.
           </p>
        </div>
