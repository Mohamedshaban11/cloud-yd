      ...
      <div className=" max-w-[1240px] mx-auto py-12">
        <div className=" text-center py-8 text-slate-300">
          ...
          <p className=" text-3xl">
            ...
            distinctio. Corporis, reiciendis itaque! Deserunt nemo numquam quas
            eum quibusdam, nostrum magnam, maxime aspernatur nobis nam a id
            saepe cum consectetur!
          </p>
        </div>
        <div className=" grid md:grid-cols-2">
            <div className=" bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative">
                ...
                <p className=" text-2xl py-8 text-slate-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus, aspernatur?</p>
